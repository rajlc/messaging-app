...
import { createProduct, getProducts, Product } from '@/services/inv-product-service';
            ...
            <div className="relative bg-white dark:bg-slate-900 rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] flex flex-col overflow-hidden border border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-100">
                ...
                <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-6 flex-1">
                    ...
                    <div className="space-y-4">
                        ...
                        {/* Header Row: Product Name, Image URL, Product ID, Product Type */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                disabled
                                className="w-full px-3 py-1.5 text-xs bg-slate-100 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-400 cursor-not-allowed"
                            />
                        </div>
                    ...
                    {/* Combo Components Section (Rendered ABOVE Seller SKUs when Product Type === 'combo') */}
                    {productType === 'combo' && (
                    ...
                    <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 flex flex-wrap items-center justify-between gap-4">
                        <div className="flex items-center gap-2">
                            ...
                            />
                            <label htmlFor="salesPriority" className="text-xs font-bold text-slate-700 dark:text-slate-200 cursor-pointer">
