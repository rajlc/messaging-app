...
export default function PagesSettings() {
    ...
    const handleFacebookLoginConnect = () => {
        ...
        const scope = selectedPlatform === 'facebook'
            ? 'pages_show_list,pages_messaging,pages_read_engagement,pages_manage_metadata,pages_manage_posts,business_management'
            : 'pages_show_list,pages_messaging,pages_read_engagement,pages_manage_metadata,pages_manage_posts,business_management,instagram_basic,instagram_manage_messages,instagram_content_publish';
